...
## 🚀 [Progression NSI terminale 2019-2020](#sommaire)
...
---------------------------------------------------------------------------------------------------------------------------
### <a name="projet1"></a> 3. Projets réalisés cette année 2020/2021 par les élèves
...
### <a name="projet3"></a> 4.1. Projet Bloc 3 : Algorithmes (troisieme trimeste)
  ...
  * ex 2 : plus grand nombre de caractères commun
  ...
  4. Quicksort and [QuickSort improved](https://yourbasic.org/golang/quicksort-optimizations/)
